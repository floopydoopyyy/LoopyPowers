...
public class MotionVestigeItem extends Item {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world,
        ...
        tooltip.add(Text.literal("It hums restlessly...")
                .formatted(Formatting.GRAY));

        tooltip.add(Text.literal("Bestows a random motion power to the subject.")
                .formatted(Formatting.DARK_PURPLE));

        tooltip.add(Text.literal("Available Powers:")
                .formatted(Formatting.GRAY));
        tooltip.add(Text.literal("Sound, Flight, Speed")
                .formatted(Formatting.GRAY));
