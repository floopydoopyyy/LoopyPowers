...
public class ElementalVestigeItem extends Item {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world,
        ...
        tooltip.add(Text.literal("It hums with primal energy...")
                .formatted(Formatting.GRAY));

        tooltip.add(Text.literal("Bestows a random elemental power to the subject.")
                .formatted(Formatting.DARK_PURPLE));

        tooltip.add(Text.literal("Available Powers:")
                .formatted(Formatting.GRAY));
        tooltip.add(Text.literal("Fire, Ice, Lightning")
                .formatted(Formatting.GRAY));
