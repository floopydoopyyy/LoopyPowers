...
public class MindVestigeItem extends Item {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world,
        ...
        tooltip.add(Text.literal("It stares back...")
                .formatted(Formatting.GRAY));

        tooltip.add(Text.literal("Bestows a random mind power to the subject.")
                .formatted(Formatting.DARK_PURPLE));

        tooltip.add(Text.literal("Available Powers:")
                .formatted(Formatting.GRAY));
        tooltip.add(Text.literal("Psychic, Telekinesis, Darkness")
                .formatted(Formatting.GRAY));
