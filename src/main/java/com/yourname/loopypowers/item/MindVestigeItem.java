...
public class MindVestigeItem extends Item {
    ...
    public MindVestigeItem(Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, Item.TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.translatable("item.loopypowers.mind_vestige.tooltip.flavor")
                .formatted(Formatting.GRAY));

        tooltip.add(Text.translatable("item.loopypowers.mind_vestige.tooltip.desc")
                .formatted(Formatting.LIGHT_PURPLE));

        tooltip.add(Text.translatable("item.loopypowers.vestige.tooltip.available")
                .formatted(Formatting.GRAY));
        tooltip.add(Text.translatable("item.loopypowers.mind_vestige.tooltip.powers")
                .formatted(Formatting.GRAY));
    }
